<template>
    <Layout>
        <div class="flex flex-wrap items-center gap-13 mb-26">
            <div v-if="workingHour" class="big-title">Edit Production Working Hour</div>
            <div v-else class="big-title">Create New Production Working Hour</div>
            ...
            <nav class="breadcrumbs">
                <ol>
                    ...
                    <li>
                        <Link href="/production-working-hours">Working Hours</Link>
                    </li>
                    <li>
                        <span v-if="workingHour">Edit Production Working Hour</span>
                        <span v-else>Create Production Working Hour</span>
                    </li>
                </ol>
            </nav>
        </div>
            ...
            <div class="form-wrap">
                <form @submit.prevent="handleSubmit">
                    <div class="boxes">
                        <div class="box border-0 border-b-[1px] border-solid border-[#EBE9F1] mb-[5.6rem]">
                            <div class="text-18 font-medium pb-17 mb-17 border-0 border-b-[1px] border-solid border-[#EBE9F1]">
                                ...
                                <span>Production Working Hour Information</span>
                            </div>
                            ...
                            <div class="grid md:grid-cols-3 gap-[7.7rem]">
                                ...
                                <div class="form-group" v-if="!hasDefault || form.is_default">
                                    ...
                                    <div class="custom-checkbox style-1">
                                        ...
                                        <label for="is-default">Set as Default Production Working Hour</label>
                                    </div>
                    ...
                    <div class="btn-group mt-[5.6rem]">
                        ...
                        <Link class="btn btn-light btn-light--brounded" href="/production-working-hours">Discard</Link>
                    </div>
...
const handleSubmit = () => {
    if (validateTime()) {
        if (props.workingHour) {
            form.put(`/production-working-hours/${props.workingHour.id}`);
        } else {
            form.post('/production-working-hours');
        }
    } else {
        Swal.fire({
            title: 'Error',
