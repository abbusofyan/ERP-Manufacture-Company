...
class ProductionProcessDetailController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $processes = Process::where('type', 'Production')->when($search, function ($query) use ($search) {
        ...
        return Inertia::render('ProductionProcessDetail/Index', [
            'processes' => $processes,
            'filters' => [],
        ]);
    }
    ...
    {
        return Inertia::render('ProductionProcessDetail/Form');
    }
    ...
    public function store(Request $request): Redirector|RedirectResponse|Application
    {
        ...
        return redirect('/production-process-detail')->with('created', 'Process created successfully');
    }
    ...
    public function update(Request $request, $process_id): Redirector|RedirectResponse|Application
    {
        ...
        return redirect('/production-process-detail')->with('updated', 'Process updated successfully');
    }
    ...
    public function destroy($process_id)
    {
        ...
        return redirect('/production-process-detail')->with('deleted', 'Process deleted successfully');
    }
}
