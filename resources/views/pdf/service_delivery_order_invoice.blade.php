...
<div class="container">
    <table class="no-borders" style="border-collapse: collapse;">
        <tr>
            ...
            <td style="vertical-align: top;">
                <h1 style="text-transform: uppercase; text-align: center">Delivery Order Invoice</h1>
            </td>
        </tr>
    </table>
        ...
        <tr>
            ...
            <td style="vertical-align: top;">
                <table class="border">
                    ...
                    <tr>
                        <td>
                            <span style="min-height: 17px; display: block">{{ $quotation->service_order_type }}</span>
                        </td>
                    </tr>
                </table>
            </td>
            <td style="vertical-align: top;">
                <table class="border">
                    ...
                    <tr>
                        <td>
                            <span style="min-height: 17px; display: block">{{ $quotation->service_order?->code }}</span>
                        </td>
                    </tr>
                </table>
            </td>
            ...
            <td style="vertical-align: top;">
                <table class="border">
                    ...
                    <tr>
                        <td>
                            <span
                                style="min-height: 17px; display: block">{{ $quotation->service_order?->confirmed?->name }}</span>
                        </td>
                    </tr>
                </table>
            </td>
            <td style="vertical-align: top;">
                <table class="border">
                    ...
                    <tr>
                        <td>
                            <span
                                style="min-height: 17px; display: block">{{ $quotation->service_order?->technician?->name }}</span>
                        </td>
                    </tr>
                </table>
            </td>
    ...
    <table class="no-borders" style="border: 1px solid #111">
        ...
        <tbody>
        @php($index = 1)
        @foreach($quotation->vehicleParts->where('service_invoice_id', $invoice->id) as $vehiclePart)
            <tr>
                <td>
                    {{ $index++ }}
                </td>
