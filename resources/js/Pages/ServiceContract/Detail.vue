                ...
                <div class="boxes">
                    ...
                    <div class="box border-0 border-b-[1px] border-solid border-[#EBE9F1] mb-[2.6rem] pb-25">
                        <div class="grid md:grid-cols-2 gap-[7.7rem]">
                            <div>
                                <p class="mb-10"><span class="text-primary text-bold">Contract:</span><br><span>{{ contract.service_contract_number }}</span></p>
                    ...
                    <div class="flex flex-wrap gap-16 justify-between mt-[5.6rem]">
                        <div>
                            <div class="btn-group">
                                <a class="btn btn-purple btn-purple--brounded" :href="`/service-contracts/${contract.id}/download`"><span>Download</span></a>
                        ...
                        <div class="btn-group">
                            <Link v-if="Number(contract.status) == 1" class="btn btn-purple" :href="`/service-contracts/${contract.id}/edit`">Edit Contract</Link>
                        </div>
                    </div>
                </div>
            </div>
...
const submitImage = () => {
    form.post(`/service-contracts/${props.contract.id}/upload-photo`, {
        onSuccess: () => {
            form.reset();
            Swal.fire({
                title: 'Success !',
...
const voidChange = () => {
    Swal.fire({
        ...
        if (result.isConfirmed) {
            Inertia.post(`/service-contracts/${props.contract.id}/void`, {}, {
                onSuccess: () => {
                    form.reset();
                    Swal.fire({
                        title: 'Success !',
