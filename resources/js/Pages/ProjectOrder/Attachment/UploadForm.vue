        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content p-24 pt-36 pb-30">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group" v-if="projectOrder.stage === 1">
                        <label>Remark</label>
                        <textarea class="form-control" v-model="form.remarks" rows="3" placeholder="Remark"></textarea>
...
const submitForm = () => {
    form.post(`/project-orders/${props.projectOrder.id}/attachments`, {
        onSuccess: () => {
