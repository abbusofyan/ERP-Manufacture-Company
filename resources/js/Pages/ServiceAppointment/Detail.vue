            ...
            <div class="form-wrap">
                <div class="boxes">
                    ...
                    <div class="box border-0 border-b-[1px] border-solid border-[#EBE9F1] mb-[5.6rem] pb-[5.6rem]">
                        ...
                        <div class="grid grid-cols-2 gap-[8rem]">
                            <table class="table-1-el w-full">
                                ...
                                <tr>
                                    <th>Service</th>
                                    <td>{{ appointment?.customer?.service_text }}</td>
                                    <th>Credit Limit</th>
                    ...
                    <div class="flex flex-wrap gap-16 justify-between mt-[5.6rem]">
                        <div class="btn-group">
                            <Link class="btn btn-purple" href="/service-appointments"><span class="icon fa-regular fa-chevron-left"></span><span>Back</span></Link>
                            <Link v-if="permissions.includes('update-service_appointment') && Number(appointment.status) === 1 && appointment.deleted_at == null" class="btn btn-light btn-light--brounded" :href="`/service-appointments/${appointment.id}/edit`">Edit</Link>
                        </div>
                        <div v-if="permissions.includes('delete-service_appointment') && ![3, 4].includes(appointment.status)" class="btn-group"><a class="btn btn-red btn-red--brounded" href="javascript:void(0)" @click="removeAppointment"><em class="fa-regular fa-xmark"></em><span>Void</span></a></div>
                    </div>
                </div>
            </div>
        </div>
...
const removeAppointment = () => {
    Swal.fire({
        ...
        if (result.isConfirmed) {
            Inertia.delete(`/service-appointments/${props.appointment.id}`, {
                onSuccess: () => {
                    Swal.fire({
                            title: 'Success !',
