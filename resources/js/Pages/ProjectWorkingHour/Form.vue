        ...
        <div class="flex flex-wrap items-center gap-13 mb-26">
            ...
            <nav class="breadcrumbs">
                <ol>
                    ...
                    <li>
                        <Link href="/project-working-hours">Working Hours</Link>
                    </li>
                    <li>
            ...
            <div class="form-wrap">
                <form @submit.prevent="handleSubmit">
                    ...
                    <div class="btn-group mt-[5.6rem]">
                        ...
                        <Link class="btn btn-light btn-light--brounded" href="/project-working-hours">Discard</Link>
                    </div>
...
const handleSubmit = () => {
    if (validateTime()) {
        if (props.workingHour) {
            form.put(`/project-working-hours/${props.workingHour.id}`);
        } else {
            form.post('/project-working-hours');
        }
    } else {
        Swal.fire({
            title: 'Error',
