...
<div class="container">
    ...
    <table class="no-borders" style="border: 1px solid #111">
        ...
        <tr>
            ...
            <td colspan="2">${{ $refrigeration_sale->sub_total }}</td>
        </tr>
        <tr>
            <td colspan="4" style="text-align: right">Discount:</td>
            <td colspan="2">${{ $refrigeration_sale->discount }}</td>
        </tr>
        <tr>
            <td colspan="4" style="text-align: right">GST:</td>
            <td colspan="2">${{ $refrigeration_sale->gst }}</td>
        </tr>
        <tr>
            <td colspan="4" style="text-align: right">Total:</td>
            <td colspan="2">${{ $refrigeration_sale->total }}</td>
        </tr>
        </tfoot>
    </table>
