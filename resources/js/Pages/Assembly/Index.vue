            ...
            <div class="flex flex-wrap gap-16 justify-between py-20 px-25 gap-1">
                ...
                <div class="flex flex-wrap gap-16 justify-between">
                    ...
                    <div class="btn-group more-button" v-if="permissions.includes('create-vendor')">
                        <Link class="btn btn-purple" href="/assembly/create">Add New List</Link>
                        <Link class="btn btn-purple" href="/assembly/replace-item">Replace Item</Link>
                    </div>
                </div>
            </div>
                ...
                <table class="table select-rows">
                    ...
                    <tbody>
                        <tr v-for="assembly in assemblies.data" :key="assembly.id">
                            <td>
                                <b class="text-purple">
                                    <Link :href="`/assembly/${assembly.id}`"><span>{{ assembly.code }}</span></Link>
                                </b>
                            </td>
                            <td>
                            ...
                            <td>
                                {{ assembly.product.category.name }}
                            </td>
                            <td>
                                {{ assembly.product.uom.code }}
                            </td>
                            <td>
                            ...
                            <td>
                                <div class="more">
                                    ...
                                    <ul class="more-panel">
                                        ...
                                        <li>
                                            <Link :href="`/assembly/${assembly.id}/duplicate`"><span class="icon fa-regular fa-copy"></span><span>Duplicate as New Assembly</span></Link>
                                        </li>
                                    </ul>
                                </div>
                            </td>
