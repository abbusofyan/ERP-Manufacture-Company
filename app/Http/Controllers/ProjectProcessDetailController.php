...
class ProjectProcessDetailController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $processes = Process::where('type', 'Project')->when($search, function ($query) use ($search) {
        ...
        return Inertia::render('ProjectProcessDetail/Index', [
            'processes' => $processes,
            'filters' => [],
        ]);
    }
    ...
    {
        return Inertia::render('ProjectProcessDetail/Form');
    }
    ...
    public function store(Request $request): Redirector|RedirectResponse|Application
    {
        ...
        return redirect('/project-process-detail')->with('created', 'Process created successfully');
    }
    ...
    public function update(Request $request, $process_id): Redirector|RedirectResponse|Application
    {
        ...
        return redirect('/project-process-detail')->with('updated', 'Process updated successfully');
    }
    ...
    public function destroy($process_id)
    {
        ...
        return redirect('/project-process-detail')->with('deleted', 'Process deleted successfully');
    }
}
