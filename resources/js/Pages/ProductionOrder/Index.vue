<template>
    <Layout>
        <div class="flex flex-wrap items-center gap-13 mb-26">
            <div class="big-title">Production Order</div>
                ...
                <table class="table select-rows">
                    ...
                    <tbody>
                        <tr v-for="order in orders.data" :key="orders.id">
                            <td>
                                <b class="text-purple">
                                    <Link :href="`/production-order/${order.id}`">{{ order.code }}</Link>
                                </b>
                             </td>
                                ...
                                <div class="more">
                                    ...
                                    <ul class="more-panel">
                                        <li v-if="permissions.includes('update-production_process_detail')">
                                            <Link :href="`/production-order/${order.id}`"><span class="icon"><img src="../../../assets/img/documents.svg" alt=""></span><span>View</span></Link>
                                        </li>
                                    </ul>
                                </div>
                            </td>
