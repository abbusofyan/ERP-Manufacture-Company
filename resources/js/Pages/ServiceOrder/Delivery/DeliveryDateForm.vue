...
const submitForm = () => {
    form.post(`/service-orders/${props.serviceOrder.id}/processes/${props.serviceOrder.current_process.id}/complete`, {
        onSuccess: () => {
    ...
    if (form.errors && form.errors.first_attachment) {
        ...
        if (modalElement) {
            ...
            if (modal) {
                modal.hide();
                Inertia.get(
                    `/service-orders/${props.serviceOrder.id}/attachments`, {},
                    {
                        preserveState: true,
                        preserveScroll: true,
                        replace: true,
