            ...
            <div class="modal-content p-24 pt-36 pb-30">
                ...
                <div class="modal-body">
                    <div class="form-group select2-w-100">
                        ...
                        <Select2
                            v-model="form.service_order_requirement_id"
                            :class="{ 'is-invalid': form.errors.service_order_requirement_id }"
                        ...
                        <div v-if="form.errors.service_order_requirement_id" class="invalid-feedback d-block">{{ form.errors.service_order_requirement_id }}</div>
                    </div>
...
const form = useForm({
    service_order_requirement_id: null,
    quantity: null,
    max_quantity: null,
    date_required: null,
});
...
const submitForm = () => {
    form.post(`/service-orders/${props.serviceOrder.id}/requirements-used`, {
        onSuccess: () => {
