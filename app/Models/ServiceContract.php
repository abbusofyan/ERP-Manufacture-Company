...
class ServiceContract extends Model
{
    ...
    public function getFullSignedImageUrlAttribute(): string|null
    {
    ...
    {
        return $this->hasMany(ServiceContractPricing::class, 'service_contract_id');
    }

    public function invoices(): HasMany
    {
        return $this->hasMany(ServiceContractInvoice::class, 'service_contract_id');
    }

    public function vehicles(): BelongsToMany
    {
        return $this->belongsToMany(Vehicle::class, 'service_contract_vehicle');
    }
    ...
    {
        return $this->hasMany(ServiceMaintain::class, 'service_contract_id');
    }

    public function vehicleItemDetails(): HasManyThrough
    {
        return $this->hasManyThrough(ServiceContractVehicleItemDetail::class, ServiceContractPricing::class, 'service_contract_id', 'service_contract_pricing_id');
    }
}
