<template>
    <div class="modal fade" :id="`uploadPaid-${serviceInvoice.id}`" role="dialog" style="overflow:hidden;">
            ...
            <div class="modal-content p-24 pt-36 pb-30">
                ...
                <div class="modal-body">
                    <div class="form-group">
                        ...
                        <p><strong>${{ serviceInvoice.remaining_amount }} (Total: ${{ serviceInvoice.service_quotation.total }})</strong></p>
                    </div>
                    <div class="form-group">
...
const submitForm = () => {
    form.post(`/service-invoices/${props.serviceInvoice.id}/paid`, {
        onSuccess: () => {
