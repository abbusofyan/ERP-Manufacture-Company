            ...
            <div class="flex flex-wrap gap-16 justify-between py-20 px-25 gap-1">
                ...
                <div class="flex flex-wrap gap-16 justify-between">
                    ...
                    <div class="btn-group more-button" v-if="permissions.includes('create-production_process_detail')">
                        <Link class="btn btn-purple" href="/service-process-detail/create">Create New</Link>
                    </div>
                </div>
            </div>
                        ...
                        <tr v-for="process in processes.data" :key="process.id">
                            ...
                            <td>
                                <div class="more">
                                    ...
                                    <ul class="more-panel">
                                        <li>
                                            <Link :href="`/service-process-detail/${process.id}/edit`"><span class="icon"><img src="../../../assets/img/edit.svg" alt=""></span><span>Edit</span></Link>
                                        </li>
                                        <li>
...
const destroy = (id) => {
    Swal.fire({
        ...
        if (result.isConfirmed) {
            Inertia.delete(`/service-process-detail/${id}`, {
                preserveScroll: true,
            });
        }
    });
