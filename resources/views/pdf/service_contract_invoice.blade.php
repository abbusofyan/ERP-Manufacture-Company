...
<head>
    ...
    <title>Service Contract Invoice #{{ $serviceContract->code }}</title>
    <style>
        body {
...
<div class="container">
    <table class="no-borders" style="border-collapse: collapse;">
        <tr>
            ...
            <td style="vertical-align: top;">
                <h1 style="text-transform: uppercase; text-align: center">Service Contract Invoice</h1>
            </td>
        </tr>
    </table>
        ...
        <tr>
                    ...
                    <tr>
                        <td>
                            <p style="display:block; min-height: 30px">
                                {{ $serviceContract->customer->code }}<br>
                                {{ $serviceContract->customer->name }}<br>
                                {{ $serviceContract->customer->country?->name }} {{ $serviceContract->customer->address }} {{ $serviceContract->customer->address_postal_code }}
                                <br>
                                Tel: ({{ $serviceContract->customer->countryPhoneCode?->phone_code }}
                                ) {{ $serviceContract->customer->phone }}
                            </p>
                        </td>
                    </tr>
                </table>
            ...
            <td style="vertical-align: top;">
                <table class="border">
                    ...
                    <tr>
                        <td>
                            <span style="min-height: 17px; display: block">{{ $serviceContract->id }}</span>
                        </td>
                    </tr>
                </table>
            </td>
            <td style="vertical-align: top;">
                <table class="border">
                    ...
                    <tr>
                        <td>
                            <span style="min-height: 17px; display: block">{{ $serviceContract->created_at->format('Y-m-d') }}</span>
                        </td>
                    </tr>
                </table>
            </td>
            ...
            <td style="vertical-align: top;">
                <table class="border">
                    ...
                    <tr>
                        <td>
                            <span style="min-height: 17px; display: block">{{ $serviceContract->term_of_payment }}</span>
                        </td>
                    </tr>
                </table>
            </td>
            <td style="vertical-align: top;">
                <table class="border">
                    ...
                    <tr>
                        <td>
                            <span style="min-height: 17px; display: block">{{ $serviceContract->customer_reference_no }}</span>
                        </td>
                    </tr>
                </table>
            </td>
        ...
        <tr>
            <td style="vertical-align: top;">
                <table class="border">
                    ...
                    <tr>
                        <td>
                            <span style="min-height: 17px; display: block">{{ $serviceContract->vehicles->pluck('license_plate')->implode(', ') }}</span>
                        </td>
                    </tr>
                </table>
            </td>
            <td style="vertical-align: top;">
                <table class="border">
                    ...
                    <tr>
                        <td>
                            <span style="min-height: 17px; display: block">{{ $serviceContract->vehicle?->warranty_mileage }}</span>
                        </td>
                    </tr>
                </table>
            </td>
            ...
            <td style="vertical-align: top;">
                <table class="border">
                    ...
                    <tr>
                        <td>
                            <span style="min-height: 17px; display: block">{{ $serviceContract->service_order?->confirmed?->name }}</span>
                        </td>
                    </tr>
                </table>
            </td>
            <td style="vertical-align: top;">
                <table class="border">
                    ...
                    <tr>
                        <td>
                            <span style="min-height: 17px; display: block">{{ $serviceContract->service_order?->technician?->name }}</span>
                        </td>
                    </tr>
                </table>
            </td>
    ...
    <table class="no-borders" style="border: 1px solid #111">
        ...
        <tbody>
        @php($index = 1)
        @foreach($serviceContract->pricing as $price)
            <tr>
                <td>
                    {{ $index++ }}
                </td>
