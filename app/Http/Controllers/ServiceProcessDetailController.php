...
class ServiceProcessDetailController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $processes = Process::where('type', 'Service')->when($search, function ($query) use ($search) {
        ...
        return Inertia::render('ServiceProcessDetail/Index', [
            'processes' => $processes,
            'filters' => [],
        ]);
    }
    ...
    {
        return Inertia::render('ServiceProcessDetail/Form');
    }
    ...
    public function store(Request $request): Redirector|RedirectResponse|Application
    {
        ...
        return redirect('/service-process-detail')->with('created', 'Process created successfully');
    }
    ...
    public function update(Request $request, $process_id): Redirector|RedirectResponse|Application
    {
        ...
        return redirect('/service-process-detail')->with('updated', 'Process updated successfully');
    }
    ...
    public function destroy($process_id)
    {
        ...
        return redirect('/service-process-detail')->with('deleted', 'Process deleted successfully');
    }
}
