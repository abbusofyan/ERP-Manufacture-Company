...
Route::middleware('auth')->group(function () {
    ...
    Route::prefix('account')->group(function () {
        ...
        Route::post('/profile/edit', [AccountController::class, 'update']);
        Route::get('/password/change', [AccountController::class, 'editPassword']);
        Route::post('/password/change', [AccountController::class, 'updatePassword']);
    });
});
