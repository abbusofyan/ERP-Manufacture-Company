            ...
            <div class="form-wrap">
                <form @submit.prevent="updateQuotation">
                    <div class="boxes">
                        <div class="box border-0 border-b-[1px] border-solid border-[#EBE9F1] mb-[5.6rem]">
                            ...
                            <div v-if="!quotation || quotation.status == 1" class="grid md:grid-cols-2 gap-[7.7rem] box border-0 border-b-[1px] border-solid border-[#EBE9F1] mb-[2.6rem]">
                                ...
                                <div class="form-group">
                                    <label>Select Service Order Number</label>
                                    <Select2
                                        ...
                                        @select="(selected) => {
                                            form.service_quotation_data = selected.data;
                                    ...
                                    <div v-if="form.errors.service_order_id" class="invalid-feedback d-block">
                                ...
                                <div>
                                    <div class="grid md:grid-cols-2 gap-[7.7rem]">
                                        <div class="form-group">
                                            ...
                                            <Select2 v-model="form.service_order_type" :class="{ 'is-invalid': form.errors.service_order_type }" :options="types" placeholder="Select Type">
                                            </Select2>
                                            <div v-if="form.errors.service_order_type" class="invalid-feedback d-block">
                                                {{ form.errors.service_order_type }}
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label>Value</label>
                                            <input class="form-control" type="text" v-model="form.service_order_value" placeholder="Value">
                                            <div v-if="form.errors.service_order_value" class="invalid-feedback d-block">
                                                {{ form.errors.service_order_value }}
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <div class="col-lg-6">
                                                <table class="table-1-el w-full">
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="el-tag" :class="{'green': form.service_quotation_data?.service_appointment?.in_warranty === '1', 'orange': form.service_quotation_data?.service_appointment?.in_warranty !== '1'}">
                                                                <span v-if="form.service_quotation_data?.service_appointment?.in_warranty === '1'">In Warranty</span>
                                            ...
                                            <div class="col-lg-6">
                                                <table class="table-1-el w-full">
                                                    <tr>
                                                        ...
                                                        <td>{{ form.service_quotation_data?.service_appointment?.pic_phone_number }}</td>
                                                    </tr>
                                                </table>
                                            </div>
                                        </div>
                    ...
                    <div class="btn-group mt-[5.6rem]">
                        ...
                        <button v-if="form.service_order_id == null" @click="form.is_generate_service_order = true" class="btn btn-purple" type="submit" :disabled="form.processing">
...
const form = useForm({
    ...
    total: null,
    image_url: null,
    is_generate_service_order: false,
});

if (props.quotation) {
    form.service_order_id = props.quotation.service_order_id;
    form.service_quotation_id = props.quotation.service_quotation_id;
    ...
    form.service_order_type = props.quotation.service_order_type;
    form.service_order_value = props.quotation.service_order_value;
...
const updateQuotation = () => {
    Swal.fire({
        ...
        if (result.isConfirmed) {
            if (props.quotation) {
                form.post(`/service-quotations/${props.quotation.id}`);
            } else {
                form.post('/service-quotations');
            }
        }
    });
};
...
const discard = () => {
    Swal.fire({
        ...
        if (result.isConfirmed) {
            Inertia.get(`/service-quotations`, {
                preserveScroll: true,
            });
        }
    });
