<template>
    <Layout>
        <div class="flex flex-wrap items-center gap-13 mb-26">
            <div class="big-title">Project Working Hours List</div>
        ...
        <div class="box rounded-md shadow-default bg-white">
            <div class="flex flex-wrap gap-16 justify-between py-20 px-25 gap-1">
                ...
                <div class="btn-group">
                    <Link class="btn btn-purple" href="/project-working-hours/create">Add New Working Hour</Link>
                </div>
            </div>
                    ...
                    <tr v-for="data in workingHours" :key="data.date">
                        ...
                        <td>
                            <div class="el-actions">
                                <Link v-if="data.specificWH && data.specificWH.id" class="text-green" :href="`/project-working-hours/${data.specificWH.id}/edit`"><em class="fa-regular fa-pen-to-square"></em></Link>
                                <Link v-else class="text-green" :href="`/project-working-hours/create?date=${data.date}`"><em class="fa-regular fa-pen-to-square"></em></Link>
                            </div>
                        </td>
                    </tr>
                    </tbody>
            ...
            <div class="table-responsive">
                <table class="table select-rows">
                    ...
                    <tr v-for="data in defaultTimes" :key="data.id">
                        ...
                        <td>
                            <div class="el-actions">
                                <Link class="text-green" :href="`/project-working-hours/${data.id}/edit`"><em class="fa-regular fa-pen-to-square"></em></Link>
                            </div>
                        </td>
                    </tr>
                    </tbody>
