<!-- resources/views/pdf/project_contract.blade.php -->
...
<head>
    ...
    <title>Project Contract PDF</title>
    <style>
        body {
...
<div>
    ...
    <div class="form-wrap">
        <div class="boxes">
            <h1 style="text-align: center">Project Contract</h1>

            <!-- Quotation Information -->
            <div class="box border-0 border-b-[1px] border-solid border-[#EBE9F1] mb-[2.6rem] pb-25">
                <table class="mb-10" style="width: 100%">
                    <tr>
                        <td><span class="text-primary text-bold">Contract:</span> {{ $contract->project_contract_number }}</td>
