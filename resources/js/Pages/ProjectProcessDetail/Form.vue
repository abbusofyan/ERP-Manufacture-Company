<template>
    <Layout>
        <div class="flex flex-wrap items-center gap-13 mb-26">
            ...
            <nav class="breadcrumbs">
                <ol>
                    ...
                    <li>
                        <Link href="/project-process-detail">Process Details</Link>
                    </li>
                    <li>
        ...
        <div class="box pt-20 px-25 pb-[5.6rem] rounded-md shadow-default bg-white">
            <div class="form-wrap">
                <form @submit.prevent="process ? form.put(`/project-process-detail/${process.id}`) : form.post('/project-process-detail')">
                    <div class="boxes">
                    ...
                    <div class="btn-group mt-[5.6rem]">
                        <Link class="btn btn-purple" href="/project-process-detail"><i class="fa fa-chevron-left text-11"></i>Back</Link>
